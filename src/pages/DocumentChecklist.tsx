...
interface Document {
  id: number;
  name: string;
  category: 'Identity' | 'Work' | 'Housing' | 'Financial' | 'Education';
  required: boolean;
  description: string;
}
...
const documents: Document[] = [
  ...
  },
  {
    ...
    category: 'Work',
    required: true,
    description: 'Signed employment contract or job offer letter'
  },
  {
    id: 3,
    ...
    category: 'Housing',
    required: true,
    description: 'Rental contract or proof of accommodation'
  },
  {
    id: 4,
    ...
    category: 'Financial',
    required: true,
    description: 'Bank statements or salary slips for last 3 months'
  },
  {
    id: 5,
    ...
    category: 'Financial',
    required: true,
    description: 'Valid health insurance coverage in Poland'
  },
  {
    id: 6,
    name: 'Diploma',
    category: 'Education',
    required: false,
    description: 'Educational certificates (if applicable)'
  },
  {
    id: 7,
    ...
    category: 'Identity',
    required: false,
    description: 'Marriage certificate (for family reunification)'
  },
  {
    id: 8,
    ...
    category: 'Identity',
    required: false,
    description: 'Birth certificate of children (if applicable)'
  }
];
